...
#   ======= =========== =========== =========== ===============
#     300 K   1.190e-14 7.62483e+10   9.071e-04 cm^3/(mol*s)
#     400 K   2.680e-08      615821   1.650e-02 cm^3/(mol*s)
#     500 K   2.073e-04      1576.2   3.268e-01 cm^3/(mol*s)
#     600 K   9.216e-02     73.2643   6.752e+00 cm^3/(mol*s)
#     800 K   2.384e+02      6.6922   1.596e+03 cm^3/(mol*s)
#    1000 K   3.253e+04     2.98712   9.718e+04 cm^3/(mol*s)
#    1500 K   3.449e+07      1.5614   5.386e+07 cm^3/(mol*s)
#    2000 K   1.523e+09     1.27694   1.945e+09 cm^3/(mol*s)
#   ======= =========== =========== =========== ===============
...
#   ======= ============ =========== ============ ============= =========
#     300 K         inf              0.000e+00     0.000e+00      cm^3/(mol*s)
#     400 K  2.719e+266             9.856e-275    6.070e-269      cm^3/(mol*s)
#     500 K  2.108e+213             9.835e-218    1.550e-214      cm^3/(mol*s)
#     600 K  8.606e+177             1.071e-179    7.846e-178      cm^3/(mol*s)
#     800 K  5.332e+133             4.472e-132    2.993e-131      cm^3/(mol*s)
#    1000 K  1.663e+107             1.956e-103    5.843e-103      cm^3/(mol*s)
#    1500 K   8.018e+71              4.302e-65     6.717e-65      cm^3/(mol*s)
#    2000 K   1.801e+54              8.458e-46     1.080e-45      cm^3/(mol*s)
#   ======= ============ =========== ============ ============= =========


# krev (TST) = Arrhenius(A=(nan,'cm^3/(mol*s)'), n=nan, Ea=(nan,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""Fitted to 8 data points; dA = *|/ nan, dn = +|- nan, dEa = +|- nan kJ/mol""") 
# krev (TST+T) = Arrhenius(A=(nan,'cm^3/(mol*s)'), n=nan, Ea=(nan,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""Fitted to 8 data points; dA = *|/ nan, dn = +|- nan, dEa = +|- nan kJ/mol""") 

kinetics(
    label = 'CC=C(C)C+[O]O_[CH2]C=C(C)C+OO',
    kinetics = Arrhenius(
        A = (1.2779e-48, 'cm^3/(mol*s)'),
        n = 17.34,
        Ea = (-8.68114, 'kJ/mol'),
        T0 = (1, 'K'),
        Tmin = (303.03, 'K'),
        Tmax = (2500, 'K'),
        comment = 'Fitted to 59 data points; dA = *|/ 91.902, dn = +|- 0.593304, dEa = +|- 3.26377 kJ/mol',
    ),
)
