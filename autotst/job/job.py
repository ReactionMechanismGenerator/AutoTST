...
#################################################################################
    ...
    def submit_conformer(self, conformer, restart=False):
        ...
        os.environ["COMMAND"] = self.qm_calculator.command  # only using gaussian for now
    ...
    def calculate_conformer(self, conformer):
        ...
        self.qm_calculator.conformer = conformer # this might be dangerous if running several of these at once?
