    ...
    if True:
        ...
        if len(reactions) < 5:
            for reaction in reactions:
                logging.info('{} and its species added to {} and {} respectively'.format(reaction, new_reactions_path, new_dict_path))
        else:
            logging.info('Reactions and their species added to {} and {} respectively'.format(new_reactions_path, new_dict_path))
    return
