#!/bin/sh
#set a job name
#SBATCH --job-name=writing_input_files

#a file for job output, you can check job progress
#SBATCH --output=writing_input_files.%a.slurm.log

# a file for errors from the job
#SBATCH --error=writing_input_files.%a.slurm.log
